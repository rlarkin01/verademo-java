...
pipeline {
    ...
    environment {
        VERACODE_APP_NAME = 'rlarkin01/verademo'      // App Name in the Veracode Platform
    }
    ...
    stages{
        ...
        //         echo 'Veracode scanning'
        //         withCredentials([ usernamePassword ( 
        //             credentialsId: 'veracode_login_fed', usernameVariable: 'VERACODE_API_ID', passwordVariable: 'VERACODE_API_KEY') ]) {
        //                 // fire-and-forget 
